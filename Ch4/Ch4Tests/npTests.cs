...
namespace org.snaga.numeric.Tests
{
    ...
    public class npTests
    {
        ...
        public void addTest4()
        {
            ...
            double[,] c = new double[,] { { 2, 4, 6 }, { 8, 10, 12 } };
            double[,] d;
        ...
        {
            double[] a = { -2, -1.5, -1, -0.5, 0, 0.5, 1, 1.5, 2 };

            double[] b = np.arange(-2.0, 2.0, 0.5);
        ...
        {
            double[] a = new double[] { 1, 2, 3 };
            double[] b = new double[] { 2.71828182845905, 7.38905609893065, 20.0855369231877 };

            double[] c = np.exp(a);

            Assert.AreEqual(np.str(b), np.str(c));
        }
        ...
        public void rowTest()
        {
            ...
            double[] b = np.row(a, 0);
            CollectionAssert.AreEqual(new double[] { 1, 2, 3 }, b);
            b = np.row(a, 1);
            CollectionAssert.AreEqual(new double[] { 4, 5, 6 }, b);
        }
        ...
        public void maxTest()
        {
            ...
            double[] c = new double[] { 1, 5, 0 };

            Assert.AreEqual(3, np.max(a));
            Assert.AreEqual(4, np.max(b));
            Assert.AreEqual(5, np.max(c));
        }
        ...
        [TestMethod()]
        public void random_randnTest()
        {
            double[,] a = np.random_randn(2, 3);

            Assert.AreEqual("[ 2, 3 ]", np.str(np.shape(a)));
            double p = a[0, 0];
        ...
        public void strTest()
        {
            ...
            Assert.AreEqual("[ 1, 2, 3 ]", np.str(a));
        }
